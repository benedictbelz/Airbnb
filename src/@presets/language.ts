...
const de: Dictionary = {
    ...
    warningCorrectCity: 'Bitte eine korrekte Stadt angeben',
...
const en: Dictionary = {
    ...
    warningCorrectCity: 'Please enter a correct city',
...
const es: Dictionary = {
    ...
    warningCorrectCity: 'Por favor, introduzca una ciudad correcta',
